 ...
 * This file demonstrates how to integrate Omenforge with a web frontend
 */

// For React/Vue/Angular applications
export class OmenforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OmenforgeClient(provider, contractAddress);
